...
<div className="card w-full h-full bg-base-100 shadow-xl ">
  ...
  <Image width={800} height={800}  src="/photos/iconphots/download.png" alt="France" className="rounded-xl " />
   Downloads </a>
  </div>
</div>
...
<div className="card w-full h-full bg-base-100 shadow-xl">
  <div className="card-body items-center text-center">
  <a href="#" className="link link-hover  text-purple-600 ">
  <Image width={800} height={800}  src="/photos/iconphots/ebrowcher.png" alt="France" className="rounded-xl " />
   E-Brouchers </a>
  </div>
</div>
...
<div className="card w-full h-full bg-base-100 shadow-xl">
  <div className="card-body items-center text-center">
  <a href="#" className="link link-hover  text-purple-600 ">
  <Image width={800} height={800}  src="/photos/iconphots/testminial.png" alt="France" className="rounded-xl " />
  Testimonials</a>
  </div>
</div>
...
<div className="card w-full h-full bg-base-100 shadow-xl">
  <div className="card-body items-center text-center">
  <a href="#" className="link link-hover  text-purple-600 ">
  <Image width={800} height={800}  src="/photos/iconphots/video.png" alt="France" className="rounded-xl " />
  Videos </a>
  </div>
</div>
...
<div className="card w-full h-full bg-base-100 shadow-xl">
  <div className="card-body items-center text-center">
  <a href="#" className="link link-hover  text-purple-600 ">
  <Image width={800} height={800}  src="/photos/iconphots/counselling.png" alt="France" className="rounded-xl " />
   Counselling</a>
  </div>
</div>
...
<div className="card w-full h-full bg-base-100 shadow-xl">
  <div className="card-body items-center text-center">
  <a href="#" className="link link-hover  text-purple-600 ">
  <Image width={800} height={800}  src="/photos/iconphots/scholarship.png" alt="France" className="rounded-xl " />
  Scholarship</a>
  </div>
</div>
</div>
