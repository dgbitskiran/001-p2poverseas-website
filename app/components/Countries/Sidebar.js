...
<Accordion   alwaysOpen={false} >
  ...
  <Accordion.Panel className="w-full" >
    <Accordion.Title className="text-red-800 ">
      ...
      <Accordion.Content>
      <Image width={800} height={800}  src="/photos/uk/uk1.png" alt="USA" className="rounded-xl " />   <br/>
      <Image width={800} height={800}   src="/photos/uk/uk2.png" alt="USA" className="rounded-xl " /> 
        </Accordion.Content>
        </Accordion.Panel>
