...
<div>
    ...
    <Image width={800} height={800} className="rounded-lg" src="/photos/round/usa.png"  alt="Bonnie image"  />
...
<div>
    ...
    <Image width={800} height={800} className="rounded-lg" src="/photos/round/ukr.png"  alt="Bonnie image"  />
...
<div>
    <div className="flex flex-col items-center m-5 ">
    <a href="/countries/uk">
    <Image width={800} height={800}  className="rounded-lg" src="/photos/round/uk.png"  alt="Bonnie image"  />
...
<div>
    ...
    <Image width={800} height={800}  className="rounded-lg" src="/photos/round/russia.png"  alt="Bonnie image"  />
...
<div>
    ...
    <Image width={800} height={800}  className="rounded-lg" src="/photos/round/pol.png"  alt="Bonnie image"  />
...
<div>
    ...
    <Image width={800} height={800}  className="rounded-lg" src="/photos/round/geo.png"  alt="Bonnie image"  />
...
<div>
    <div className="flex flex-col items-center m-5 ">
    <Image width={800} height={800}  className="rounded-lg" src="/photos/round/swedan.png"  alt="Bonnie image"  />
...
<Image width={800} height={800}  src="/photos/mbbs/smb.png"  alt="MBBS"  />
</div>
</div>
