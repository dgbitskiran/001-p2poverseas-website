...
<div>
  <Card className="bg-gradient-to-r from-red-200 to-blue-300">
    <div className="flex flex-col items-center pb-2">
      <Image width={100} height={100} className="mb-3  rounded-full shadow-lg" src="/photos/coaching/dvd.png" alt="Course DVD" />
...
<Card className="bg-gradient-to-r from-blue-200 to-yellow-200">
    <div className="flex flex-col items-center pb-6">
      <Image width={100} height={100} className="mb-3  rounded-full shadow-lg" src="/photos/coaching/moc.png" alt="Course DVD" />
      <h5 className=" text-xl font-medium text-gray-900 dark:text-white">
...
<Card className="bg-gradient-to-r from-green-200 to-blue-300">
    <div className="flex flex-col items-center pb-10">
      <Image width={100} height={100} className="mb-3 rounded-full shadow-lg" src="/photos/coaching/ass.png" alt="Course DVD" />
      <h5 className="text-xl font-medium text-gray-900 dark:text-white">
...
<Card className="bg-gradient-to-r from-red-200 to-gray-200">
    <div className="flex flex-col items-center pb-10">
      <Image width={100} height={100} className="mb-3 rounded-full shadow-lg" src="/photos/coaching/time.png" alt="Course DVD" />
      <h5 className=" text-xl font-medium text-gray-900 dark:text-white">
...
<Card className="bg-gradient-to-r from-red-200 to-yellow-200">
    <div className="flex flex-col items-center pb-10">
      <Image width={800} height={800} className="mb-3 h-24 w-24 rounded-full shadow-lg" src="/photos/coaching/pt.png" alt="Course DVD" />
      <h5 className="text-xl font-medium text-gray-900 dark:text-white">
